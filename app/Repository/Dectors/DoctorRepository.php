<?php 
namespace App\Repository\Dectors;
...
class DoctorRepository implements DoctorRepositoryInterface
{
    ...
    public function store($request){
        ...
        try {
            ...
            //Upload img
            $this->verifyAndStoreImage($request,'photo','doctors','upload_image',$doctors->id,'App\Models\Dector');

            DB::commit();
            session()->flash('add');
            return redirect()->route('admin.dectors.create');
    ...
    public function destroy($request)
    {
      if($request->page_id==1){
       ...
       Dector::destroy($request->id);
          session()->flash('delete');
          return redirect()->route('admin.dectors.index');
      }
    ...
    public function update($request)
    {
        ...
        try {
            ...
            $doctor = Dector::findorfail($request->id);
